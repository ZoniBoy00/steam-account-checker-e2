...
import { Key, Save, Trash2, Eye, EyeOff, AlertTriangle, Shield, CheckCircle, Package } from "lucide-react"
    ...
    <div className="space-y-6">
      ...
      <Card className="bg-slate-800/50 border-slate-700">
        <CardHeader>
          ...
          <CardDescription className="text-slate-400">
            Configure inventory checking options for CS2 items and market values.
          </CardDescription>
        </CardHeader>
